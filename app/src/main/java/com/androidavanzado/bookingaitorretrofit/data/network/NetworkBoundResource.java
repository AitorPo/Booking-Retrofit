...
public abstract class NetworkBoundResource<ResultType extends Hotel, RequestType> {
    private final MediatorLiveData<Resource<ResultType>> result = new MediatorLiveData<>();

    @MainThread
    public NetworkBoundResource() {
        result.setValue(Resource.loading(null));
        LiveData<ResultType> dbSource = (LiveData<ResultType>) loadFromDb();
    ...
    @NonNull
    @MainThread
    protected abstract LiveData<Hotel> loadFromDb();
